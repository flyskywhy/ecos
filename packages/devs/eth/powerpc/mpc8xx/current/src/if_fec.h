...
#define FEC_BD_Rx_RO1       0x4000  // Receive software ownership bit
#define FEC_BD_Rx_Wrap      0x2000  // Last buffer in ring [wrap]
#define FEC_BD_Rx_RO2       0x1000  // Receive software ownership bit
#define FEC_BD_Rx_Last      0x0800  // Last buffer in frame
#define FEC_BD_Rx_Miss      0x0100  //
#define FEC_BD_Rx_BC        0x0080  // Set if the DA is broadcast
#define FEC_BD_Rx_MC        0x0040  // Set if the DA is multicast and not broadcast
#define FEC_BD_Rx_LG        0x0020  // Rx frame length violation
#define FEC_BD_Rx_NO        0x0010  // Rx nonoctet-aligned frame
...
#define FEC_BD_Rx_ERR       (FEC_BD_Rx_LG|FEC_BD_Rx_NO|FEC_BD_Rx_SH|FEC_BD_Rx_CR|FEC_BD_Rx_OV|FEC_BD_Rx_TR)
...
struct fec_eth_info {
    ...
    unsigned long               txkey[CYGNUM_DEVS_ETH_POWERPC_MPC8xx_TxNUM];
};
...
/* FEC_IVEC_VAL MUST match CYGNUM_DEVS_ETH_POWERPC_MPC8xx_INT_LEVEL */
#if (CYGNUM_DEVS_ETH_POWERPC_MPC8xx_INT_LEVEL == CYGNUM_HAL_INTERRUPT_SIU_LVL1)
  #define FEC_IVEC_VAL            0x20000000
#elif (CYGNUM_DEVS_ETH_POWERPC_MPC8xx_INT_LEVEL == CYGNUM_HAL_INTERRUPT_SIU_LVL2)
  #define FEC_IVEC_VAL            0x40000000
#elif (CYGNUM_DEVS_ETH_POWERPC_MPC8xx_INT_LEVEL == CYGNUM_HAL_INTERRUPT_SIU_LVL3)
  #define FEC_IVEC_VAL            0x60000000
#elif (CYGNUM_DEVS_ETH_POWERPC_MPC8xx_INT_LEVEL == CYGNUM_HAL_INTERRUPT_SIU_LVL4)
  #define FEC_IVEC_VAL            0x80000000
#elif (CYGNUM_DEVS_ETH_POWERPC_MPC8xx_INT_LEVEL == CYGNUM_HAL_INTERRUPT_SIU_LVL5)
  #define FEC_IVEC_VAL            0xA0000000
#elif (CYGNUM_DEVS_ETH_POWERPC_MPC8xx_INT_LEVEL == CYGNUM_HAL_INTERRUPT_SIU_LVL6)
  #define FEC_IVEC_VAL            0xC0000000
#elif (CYGNUM_DEVS_ETH_POWERPC_MPC8xx_INT_LEVEL == CYGNUM_HAL_INTERRUPT_SIU_LVL7)
  #define FEC_IVEC_VAL            0xE0000000
#else
  #error "Unknown value for CYGNUM_DEVS_ETH_POWERPC_MPC8xx_INT_LEVEL"
#endif
...
/* Configuration 2 (LED and misc characteristics) */
# define PHY_LSI80223_REG17         0x11
# define PHY_LSI80223_PLED3_1       0x8000  /* LED Toggles and Behavior Bits. */
# define PHY_LSI80223_PLED3_0       0x4000  /* See LSI Datasheet, p43 for a   */
# define PHY_LSI80223_PLED2_1       0x2000  /* complete description of        */
# define PHY_LSI80223_PLED2_0       0x1000  /* functionality.                 */
# define PHY_LSI80223_PLED1_1       0x0800
# define PHY_LSI80223_PLED1_0       0x0400
# define PHY_LSI80223_PLED0_1       0x0200
# define PHY_LSI80223_PLED0_0       0x0100
# define PHY_LSI80223_LED_DEF1      0x0080
# define PHY_LSI80223_LED_DEF0      0x0040
#endif

__externC int if_fec_num_rx_interrupts;
__externC int if_fec_num_rx_drops;
__externC int if_fec_num_rx_error_lg;
__externC int if_fec_num_rx_error_no;
__externC int if_fec_num_rx_error_sh;
__externC int if_fec_num_rx_error_cr;
__externC int if_fec_num_rx_error_ov;
__externC int if_fec_num_rx_error_tr;

__externC int if_fec_num_tx_error_lc;
__externC int if_fec_num_tx_error_rl;
__externC int if_fec_num_tx_error_ur;

/* Function Prototypes */
__externC int fec_eth_li_status(void);
