...
/** \file microblaze_strataflash.c
 * Support for the Strata flash device.
 */
...
static const CYG_FLASH_FUNS(hal_microblaze_flash_strata_funs,
...
static cyg_strata_dev hal_microblaze_flash_priv;
#ifdef notusingcfianymore
 = {
    .manufacturer_code  = 0x0089,
    .device_code        = 0x8919,
    .bufsize            = 32,       // 32 bytes -> 16 words
    .block_info = {
        { 0x00020000, 256 }
    }
};
...
CYG_FLASH_DRIVER(hal_microblaze_flash,
                 &hal_microblaze_flash_strata_funs,
                 0,
                 MICROBLAZE_FLASH_BASE,
                 (MICROBLAZE_FLASH_BASE+MICROBLAZE_FLASH_SIZE-1),
                 1,
                 hal_microblaze_flash_priv.block_info,
                 &hal_microblaze_flash_priv
);
